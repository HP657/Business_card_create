...
class DB:
    ...
    def add_user(self, name, password, share_password, img):
        self.execute_query("INSERT INTO users (name, password, share_password, img) VALUES (%s, %s, %s, %s);", (name, password, share_password, img))
